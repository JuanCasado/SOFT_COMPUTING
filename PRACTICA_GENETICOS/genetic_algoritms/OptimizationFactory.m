function optimization = OptimizationFactory (domain_name, evaluator_name, fenotype_len, ...
                                             optimization_name, population_len)
    ...
    if optimization_name == "genetic_simple"
        optimization = @() GeneticSimple(domain, evaluator, newGenotype, newFenotype, newPopulation);
